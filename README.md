...
1. Run the Composer require command to install the package
    ...
    ```bash
    composer require https://github.com/ana-lisboa/bootforms
    ```
...
2. In your app config, add the Service Provider in the `$providers` array **after** `BootFormsServiceProvider` and `TranslatableServiceProvider`
    ...
    'providers' => [
        ...
        ...
        AnaLisboa\LaravelTranslatableBootForms\TranslatableBootFormsServiceProvider::class,
    ],
    ```
3. In your app config, add the Facade to the `$aliases` array
    ...
    'aliases' => [
        ...
        'TranslatableBootForm' => AnaLisboa\LaravelTranslatableBootForms\Facades\TranslatableBootForm::class,
    ],
    ```
...
4. Publish the configuration file
    ...
    ```bash
    php artisan vendor:publish --provider="AnaLisboa\LaravelTranslatableBootForms\TranslatableBootFormsServiceProvider" --tag="config"
    ```
